...
export default function Home() {
  return (
    <Layout
      ...
      description="A ~1.3 kB TypeScript utility that returns a strict union for the current user-agent. Works in Node, Next.js, Remix, Workers, Deno, and the browser. Zero runtime dependencies."
    >
      <Hero />
